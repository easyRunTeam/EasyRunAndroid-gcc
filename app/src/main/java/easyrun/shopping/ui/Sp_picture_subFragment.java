...
import easyrun.shopping.data.PictureData;
...
import easyrun.shopping.view.FilterView;
import easyrun.shopping.view.HeaderAdViewView;
import easyrun.shopping.view.HeaderChannelViewView;
import easyrun.shopping.view.HeaderDividerViewView;
import easyrun.shopping.view.HeaderFilterViewView;
import easyrun.shopping.view.HeaderOperationViewView;
 ...
 */
public class Sp_picture_subFragment extends Fragment implements SmoothListView.ISmoothListViewListener {
    ...
    private void initData() {
        ...
        filterData.setCategory(PictureData.getCategoryData());
        filterData.setSorts(PictureData.getSortData());
        filterData.setFilters(PictureData.getFilterData());

        // 广告数据
        adList = PictureData.getAdData();

        // 频道数据
        channelList = PictureData.getChannelData();

        // 运营数据
        operationList = PictureData.getOperationData();
    ...
    private void initListener() {
        ...
        fvTopFilter.setOnItemCategoryClickListener(new FilterView.OnItemCategoryClickListener() {
            ...
            public void onItemCategoryClick(FilterTwoEntity entity) {
                fillAdapter(PictureData.getCategoryData(entity, clothesList));
            }
        });
        ...
        fvTopFilter.setOnItemSortClickListener(new FilterView.OnItemSortClickListener() {
            ...
            public void onItemSortClick(FilterEntity entity) {
                fillAdapter(PictureData.getSortData(entity, clothesList));
            }
        });
        ...
        fvTopFilter.setOnItemFilterClickListener(new FilterView.OnItemFilterClickListener() {
            ...
            public void onItemFilterClick(FilterEntity entity) {
                fillAdapter(PictureData.getFilterData(entity, clothesList));
            }
        });
    ...
    private void fillAdapter(List<ClothesEntity> list) {
        if (list == null || list.size() == 0) {
            ...
            mAdapter.setData(PictureData.getNoDataEntity(height));
        } else {
