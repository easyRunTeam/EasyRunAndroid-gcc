...
import easyrun.shopping.adapter.FilterLeftAdapter;
import easyrun.shopping.adapter.FilterOneAdapter;
import easyrun.shopping.adapter.FilterRightAdapter;
...
public class FilterView extends LinearLayout implements View.OnClickListener {
    ...
    private void setCategoryAdapter() {
        tvCategory.setTextColor(mActivity.getResources().getColor(R.color.ios_purple));
    ...
    private void setSortAdapter() {
        tvSort.setTextColor(mActivity.getResources().getColor(R.color.ios_purple));
    ...
    private void setFilterAdapter() {
        tvFilter.setTextColor(mActivity.getResources().getColor(R.color.ios_purple));
